...
public class StudentDao extends AbstractDao<Student, Void> {
    ...
    public static class Properties {
        ...
        public final static Property Set = new Property(4, String.class, "set", false, "SET");
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // set
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setSet(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
